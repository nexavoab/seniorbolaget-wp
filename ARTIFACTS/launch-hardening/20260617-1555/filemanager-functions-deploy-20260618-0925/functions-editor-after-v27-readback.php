...
/**
 * SENIORBOLAGET STAGING GOOGLE FONT LINK STRIP V27 HOTFIX START 2026-06-18
 * Rollback: restore ARTIFACTS/launch-hardening/20260617-1555/filemanager-functions-deploy-20260618-0925/functions-after-v26.php
...
add_action( 'template_redirect', function () {
	...
	ob_start( function ( $html ) {
		...
		return preg_replace( '/<link\b(?=[^>]*(?:fonts\.googleapis\.com|fonts\.gstatic\.com))[^>]*>\s*/i', '', $html );
	} );
}, 0 );
// SENIORBOLAGET STAGING GOOGLE FONT LINK STRIP V27 HOTFIX END 2026-06-18
