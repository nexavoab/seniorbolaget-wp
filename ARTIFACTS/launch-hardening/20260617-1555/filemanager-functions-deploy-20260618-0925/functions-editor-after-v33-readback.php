...
/**
 * SENIORBOLAGET STAGING FORM MAIL ROUTING V33 HOTFIX START 2026-06-19
 * Rollback: restore functions-editor-after-v32-readback.php or remove V33 form blocks, then clear staging cache.
 * Scope: send staging form tests to Wasim while keeping production recipient unchanged.
 */
...
// SENIORBOLAGET STAGING FORM MAIL ROUTING V33 HOTFIX END 2026-06-19
...
/**
 * SENIORBOLAGET STAGING CONTACT FORM HANDLER V33 HOTFIX START 2026-06-19
 * Rollback: restore functions-editor-after-v32-readback.php or remove V33 contact blocks, then clear staging cache.
 * Scope: make the three contact-page tab forms submit to a real WordPress handler.
 */
add_action('wp_ajax_sb_contact_inquiry', 'seniorbolaget_contact_inquiry_submit');
add_action('wp_ajax_nopriv_sb_contact_inquiry', 'seniorbolaget_contact_inquiry_submit');
add_action('admin_post_sb_contact_inquiry', 'seniorbolaget_contact_inquiry_submit');
add_action('admin_post_nopriv_sb_contact_inquiry', 'seniorbolaget_contact_inquiry_submit');

if (!function_exists('seniorbolaget_contact_inquiry_submit')) {
...
function seniorbolaget_contact_form_submit_script() {
    ...
    window.sbSubmitForm = async function(e, type) {
        ...
        formData.append('action', 'sb_contact_inquiry');
...
// SENIORBOLAGET STAGING CONTACT FORM HANDLER V33 HOTFIX END 2026-06-19
