<?php
/**
 * Title: Snickeri - Tjänstesida
 * Slug: seniorbolaget/snickeri-page
 * Categories: seniorbolaget, services
 * Description: Komplett tjänstesida för snickeri och hantverk
 * Viewport Width: 1440
 */
?>
...
<div style="position:relative;min-height:85vh;display:flex;align-items:center;background-image:url('https://staging.seniorbolaget.se/wp-content/uploads/2026/02/service_hantverk.jpg');background-size:cover;background-position:center;overflow:hidden;">
  ...
  <div style="position:relative;z-index:2;max-width:720px;padding:clamp(40px,8vw,100px) clamp(24px,5vw,80px);padding-top:70px;">
    ...
    <h1 style="font-family:Rubik,sans-serif;font-size:clamp(2.25rem,5vw,3.5rem);font-weight:800;color:#fff;line-height:1.15;margin:0 0 20px;">
      <span class="accent" style="color:#FF6B6B;">Snickeri</span> och bygg med lång erfarenhet
    </h1>
    <p style="font-family:Inter,sans-serif;font-size:clamp(1rem,1.5vw,1.25rem);color:rgba(255,255,255,0.9);line-height:1.7;margin:0 0 32px;max-width:560px;">
      Hyllor, dörrar, renoveringar och byggen — professionellt utförande av erfarna 55+
    </p>
...
<div class="wp-block-group alignfull" style="background-color:#FAFAF8;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-weight:700;margin-bottom:3rem">Vad ingår i snickeriarbetet?</h2>
	<!-- /wp:heading -->
	...
	<div class="seniorbolaget-bento" style="display:grid;grid-template-columns:repeat(4,1fr);grid-template-rows:auto auto;gap:16px;max-width:1100px;margin:0 auto;">
	  ...
	  <!-- Stort kort — Hyllor & förvaring (2 kolumner) -->
	  <div style="grid-column:span 2;background:#fff;border-radius:20px;padding:36px;box-shadow:0 2px 16px rgba(0,0,0,0.06);display:flex;flex-direction:column;gap:16px;">
	    <div style="width:48px;height:48px;background:#FFF4F2;border-radius:12px;display:flex;align-items:center;justify-content:center;">
	      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M3 15h18M9 3v18"/></svg>
	    </div>
	    <div>
	  ...
	  <div style="background:#FFF4F2;border-radius:20px;padding:28px;box-shadow:0 2px 16px rgba(0,0,0,0.04);display:flex;flex-direction:column;gap:12px;">
	    <div style="width:44px;height:44px;background:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;">
	      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M5 7V4a1 1 0 011-1h12a1 1 0 011 1v3"/></svg>
	    </div>
	    <p style="font-family:Rubik,sans-serif;font-weight:700;font-size:1.05rem;color:#1F2937;margin:0;">Möbelmontering</p>
	    <p style="font-family:Inter,sans-serif;font-size:0.875rem;color:#6B7280;margin:0;line-height:1.5;">Från platt till klart. Vi monterar all typ av möbler noggrant.</p>
	  </div>

	  <!-- Litet kort — Dörrar & fönster -->
	  <div style="background:#FAFAF8;border-radius:20px;padding:28px;box-shadow:0 2px 16px rgba(0,0,0,0.04);display:flex;flex-direction:column;gap:12px;">
	    <div style="width:44px;height:44px;background:#fff;border-radius:12px;display:flex;align-items:center;justify-content:center;">
	      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18M9 12h3"/></svg>
	    </div>
	    <p style="font-family:Rubik,sans-serif;font-weight:700;font-size:1.05rem;color:#1F2937;margin:0;">Dörrar &amp; fönster</p>
	    <p style="font-family:Inter,sans-serif;font-size:0.875rem;color:#6B7280;margin:0;line-height:1.5;">Byte, justering och tätning. Drag och skrällar försvinner.</p>
	  </div>

	  <!-- Bred rad — Renovering & reparationer (3 kolumner) -->
	  <div style="grid-column:span 3;background:linear-gradient(135deg,#C91C22 0%,#a01519 100%);border-radius:20px;padding:28px 36px;display:flex;align-items:center;justify-content:space-between;gap:24px;">
	    <div>
	      <p style="font-family:Rubik,sans-serif;font-weight:700;font-size:1.1rem;color:#fff;margin:0 0 6px;">Renovering &amp; reparationer</p>
	      <p style="font-family:Inter,sans-serif;font-size:0.875rem;color:rgba(255,255,255,0.85);margin:0;">Golv, lister, sparklar, målning — vi fixar det lilla som gör stor skillnad.</p>
	    </div>
	    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.7)" stroke-width="1.5"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z"/></svg>
	  </div>
...
<div class="wp-block-group alignfull" style="background-color:#FFFFFF;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
			...
			<p style="color:#4B5563;font-size:1rem;line-height:1.7;margin-bottom:1rem">ROT-avdraget innebär att du som privatperson kan få 30% skattereduktion på arbetskostnaden för reparation, ombyggnad och tillbyggnad — inklusive snickeriarbeten.</p>
			<!-- /wp:paragraph -->
				...
				<div style="margin-top:1.5rem;">
					...
					<ol style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:0.75rem;">
						<li style="display:flex;align-items:flex-start;gap:12px;">
							...
							<span style="color:#4B5563;font-size:0.9375rem;padding-top:4px;">Vi utför snickeriarbetet och fakturerar dig <strong>70% av priset</strong></span>
						</li>
						<li style="display:flex;align-items:flex-start;gap:12px;">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<h3 class="wp-block-heading" style="color:#1F2937;font-size:1.125rem;font-weight:600">Rätt gjort från start</h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"style":{"color":{"text":"#4B5563"},"typography":{"fontSize":"0.9375rem"}}} -->
					<p style="color:#4B5563;font-size:0.9375rem">Gedigen yrkeserfarenhet — inga genvägar, inga kompromisser.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.125rem","fontWeight":"600"},"color":{"text":"#1F2937"}}} -->
					<h3 class="wp-block-heading" style="color:#1F2937;font-size:1.125rem;font-weight:600">Snyggt och städat</h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph {"style":{"color":{"text":"#4B5563"},"typography":{"fontSize":"0.9375rem"}}} -->
					<p style="color:#4B5563;font-size:0.9375rem">Vi lämnar aldrig ett jobb halvfärdigt eller ett rum ostädat.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
...
<div class="wp-block-group alignfull has-background" style="background-color:#4A5568;padding-top:100px;padding-bottom:100px;">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#fff;font-size:clamp(1.75rem,4vw,2.5rem);font-weight:700;margin-bottom:1rem;">Snickerihjälp som håller — boka en erfaren hantverkare</h2>
  <!-- /wp:heading -->
  ...
  <p class="has-text-align-center" style="color:rgba(255,255,255,0.85);font-size:1.125rem;margin-bottom:2.5rem;">Boka snickare idag. Vi matchar dig med rätt senior — och ROT-avdraget sköter vi åt dig.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons">
    ...
    <div class="wp-block-button"><a class="wp-block-button__link has-vit-color has-rod-background-color has-text-color has-background wp-element-button" href="/intresseanmalan/" style="border-radius:50px;padding:1rem 2.5rem;font-size:1.125rem;font-weight:700;">Boka snickare</a></div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
