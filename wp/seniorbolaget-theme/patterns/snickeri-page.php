...
<div class="wp-block-group alignfull" style="background-color:#FFF4F2;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:55%">
			...
			<p style="color:#6B7280;font-size:0.75rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.5rem">Privat · Snickeri</p>
			<!-- /wp:paragraph -->
			...
			<h1 class="wp-block-heading" style="color:#1F2937;font-size:clamp(2rem, 5vw, 3rem);font-weight:700;line-height:1.1;margin-bottom:1.5rem">Snickeri & hantverk av erfarna seniorer</h1>
			<!-- /wp:heading -->
			...
			<p style="color:#4B5563;font-size:1.375rem;font-weight:500;line-height:1.5;margin-bottom:1rem">Hantverk med precision</p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.125rem","lineHeight":"1.7"},"color":{"text":"#4B5563"},"spacing":{"margin":{"bottom":"2rem"}}}} -->
			<p style="color:#4B5563;font-size:1.125rem;line-height:1.7;margin-bottom:2rem">Behöver du hjälp med snickeriarbeten? Våra seniorer fixar allt från hyllor och möbler till enklare renoveringar med gedigen yrkeserfarenhet och noggrannhet.</p>
			<!-- /wp:paragraph -->
