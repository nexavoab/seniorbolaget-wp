...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Martin Engström ledde säljteam i 25 år innan han bytte bana. Han ville bygga något eget — och hjälpa människor på riktigt.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Sedan 2019 är han en av Örebroregionens mest erfarna franchisetagare. Hans team är kända för sin professionalism.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Martin säger att hemligheten är enkel: anställ bra människor, lita på dem, och leverera det du lovar.</p>
  </div>
