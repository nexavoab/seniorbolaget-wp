...
<div class="wp-block-group alignfull" style="background-color:#FFF4F2;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%">
			...
			<figure class="wp-block-image size-large is-style-default"><img src="http://localhost:8888/wp-content/uploads/2026/02/service_hantverk.jpg" alt="Målning och tapetsering av Seniorbolaget" class="wp-image-127" style="border-radius:16px"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
