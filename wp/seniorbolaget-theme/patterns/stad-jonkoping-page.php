...
<div class="franchisee-hero" style="display:flex;gap:48px;align-items:center;flex-wrap:wrap;">
  ...
  <div style="flex:1;min-width:280px;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:1rem;color:#6B7280;margin:0 0 20px;">
      Franchisetagare · Jönköping · Sedan 2020
    </p>
    ...
    <div style="margin-bottom:24px;">
      <a href="mailto:roland.rapp@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;text-decoration:none;">
        ✉ Skicka mail till Roland
      </a>
    </div>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Henrik Ekström drev eget byggföretag i Jönköping i 25 år. När han sålde det ville han inte bara sluta jobba — han ville fortsätta bidra.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Seniorbolaget passade perfekt. Sedan 2020 har han byggt ett tight team som kombinerar hantverkskunnande med genuin omsorg.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Henrik skämtar ofta om att han jobbar hårdare nu än någonsin — men att det aldrig känns som jobb.</p>
  </div>
