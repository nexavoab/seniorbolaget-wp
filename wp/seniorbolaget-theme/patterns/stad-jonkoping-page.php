...
<div style="position:relative;min-height:80vh;display:flex;align-items:flex-end;background-image:url('https://staging.seniorbolaget.se/wp-content/uploads/2026/02/franchisee_jonkoping.jpg');background-size:cover;background-position:center top;overflow:hidden;">
  ...
  <div style="position:relative;z-index:2;width:100%;padding:clamp(32px,5vw,60px) clamp(24px,5vw,80px);display:flex;justify-content:space-between;align-items:flex-end;flex-wrap:wrap;gap:24px;">
    <div>
      ...
      <h1 style="font-family:Rubik,sans-serif;font-size:clamp(2rem,5vw,3.25rem);font-weight:800;color:#fff;line-height:1.1;margin:0 0 8px;">Roland Rapp · Jönköping</h1>
