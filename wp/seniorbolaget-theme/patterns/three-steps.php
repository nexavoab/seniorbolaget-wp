 ...
 * Description: Tre steg som beskriver hur tjänsten fungerar
 * Viewport Width: 1280
 */
?>
...
<div class="wp-block-group alignfull" style="background-color:#FAFAF8">
	...
	<div class="wp-block-group" style="text-align:center">
		...
		<p class="has-rod-color has-text-color" style="font-size:0.8rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase">Så enkelt fungerar det</p>
		<!-- /wp:paragraph -->
		<!-- wp:heading {"level":2,"style":{"typography":{"fontWeight":"700"}}} -->
		<h2 class="wp-block-heading">Vår process i tre steg</h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
