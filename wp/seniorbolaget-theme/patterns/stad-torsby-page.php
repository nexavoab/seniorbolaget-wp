<?php
/**
 * Title: Torsby - Stadssida
 * Slug: seniorbolaget/stad-torsby-page
 * Categories: seniorbolaget, services
 * Description: SEO-landningssida för Torsby med rikt franchisetagarkort och testimonials
 * Viewport Width: 1440
 */
?>
...
<div class="wp-block-group alignfull" style="background-color:#FFF4F2;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div class="wp-block-group alignwide">
    ...
    <div class="wp-block-group">
      ...
      <p style="color:#6B7280;font-size:0.75rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.5rem">Här finns vi · Torsby</p>
      <!-- /wp:paragraph -->
      ...
      <h1 class="wp-block-heading" style="color:#1F2937;font-size:clamp(2rem, 5vw, 3rem);font-weight:700;line-height:1.1;margin-bottom:1rem">Hemtjänster i Torsby av erfarna seniorer</h1>
      <!-- /wp:heading -->

      <!-- wp:paragraph {"style":{"typography":{"fontSize":"1.125rem","lineHeight":"1.7"},"color":{"text":"#4B5563"},"spacing":{"margin":{"bottom":"2rem"}}}} -->
      <p style="color:#4B5563;font-size:1.125rem;line-height:1.7;margin-bottom:2rem">Seniorbolaget finns i Torsby med erfarna och pålitliga seniorer. Vi hjälper dig med hemstädning, trädgård, målning och snickeri — alltid med omtanke och kvalitet.</p>
      <!-- /wp:paragraph -->
      ...
      <div class="wp-block-buttons">
        ...
        <div class="wp-block-button"><a class="wp-block-button__link has-vit-color has-rod-background-color has-text-color has-background wp-element-button" href="/intresse-anmalan" style="border-radius:50px;padding:0.875rem 2rem;font-weight:600;font-size:1rem;">Boka hjälp i Torsby</a></div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->

      <!-- wp:paragraph {"style":{"typography":{"fontSize":"0.875rem"},"color":{"text":"#6B7280"},"spacing":{"margin":{"top":"0.75rem"}}}} -->
      <p style="font-size:0.875rem;color:#6B7280;margin-top:0.75rem;">✓ Lokalt i Torsby &nbsp;·&nbsp; ✓ Svar inom 24h &nbsp;·&nbsp; ✓ Inga bindningstider</p>
      <!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull" style="background-color:#FAFAF8;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:clamp(1.75rem,4vw,2.5rem);font-weight:700;margin-bottom:0.75rem">Vad kan vi hjälpa dig med i Torsby?</h2>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#6B7280"},"typography":{"fontSize":"1.125rem"},"spacing":{"margin":{"bottom":"3rem"}}}} -->
  <p class="has-text-align-center" style="color:#6B7280;font-size:1.125rem;margin-bottom:3rem">Välj den tjänst du behöver — vi matchar dig med rätt senior i Torsby.</p>
  <!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:clamp(1.75rem,4vw,2.25rem);font-weight:700;margin-bottom:2.5rem">Möt din lokala kontakt i Torsby</h2>
  <!-- /wp:heading -->
...
<div style="max-width:820px;margin:0 auto;background:#fff;border-radius:24px;padding:40px;box-shadow:0 4px 24px rgba(0,0,0,0.08);display:flex;gap:40px;align-items:flex-start;flex-wrap:wrap;">
  ...
  <div style="flex:0 0 160px;text-align:center;">
    ...
    <svg width="160" height="160" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="bgGrad_RN" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stop-color="#FFF4F2"/>
          <stop offset="100%" stop-color="#FFE4E1"/>
        </linearGradient>
      </defs>
      <circle cx="80" cy="80" r="80" fill="url(#bgGrad_RN)"/>
      ...
      <text x="80" y="72" text-anchor="middle" font-family="Rubik,sans-serif" font-size="32" font-weight="700" fill="#C91C22" opacity="0.9">RN</text>
    </svg>
    <!-- Verifierad badge -->
  ...
  <div style="flex:1;min-width:220px;">
    ...
    <div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:2px;">
      <h3 style="font-family:Rubik,sans-serif;font-size:1.375rem;font-weight:700;color:#1F2937;margin:0;">Rolf Nilsson</h3>
    ...
    <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;margin:0 0 14px;">Ansvarig Torsby · Aktiv sedan 2021</p>

    <!-- Bio -->
    <p style="font-family:Inter,sans-serif;font-size:0.9375rem;line-height:1.75;color:#374151;margin:0 0 16px;">Göran Eriksson driver Seniorbolaget Torsby sedan 2021. Som infödd värmländning förstår han bygdens behov och har samlat ett team av erfarna seniorer som verkligen bryr sig om sina kunder.</p>
    ...
    <div style="margin-bottom:18px;">
      ...
      <div style="display:flex;gap:6px;flex-wrap:wrap;">
        <span style="background:#F3F4F6;color:#374151;border-radius:50px;padding:4px 12px;font-size:0.8125rem;font-family:Inter,sans-serif;">Torsby</span>
        <span style="background:#F3F4F6;color:#374151;border-radius:50px;padding:4px 12px;font-size:0.8125rem;font-family:Inter,sans-serif;">Sunne</span>
        <span style="background:#F3F4F6;color:#374151;border-radius:50px;padding:4px 12px;font-size:0.8125rem;font-family:Inter,sans-serif;">Likenäs</span>
        <span style="background:#F3F4F6;color:#374151;border-radius:50px;padding:4px 12px;font-size:0.8125rem;font-family:Inter,sans-serif;">Sysslebäck</span>
      </div>
    </div>
    ...
    <div style="display:flex;gap:24px;flex-wrap:wrap;margin-bottom:20px;padding:16px;background:#FAFAF8;border-radius:12px;">
      <div>
        <p style="font-family:Rubik,sans-serif;font-weight:700;color:#C91C22;margin:0;font-size:1.25rem;">85+</p>
    ...
    <div style="display:flex;gap:12px;flex-wrap:wrap;">
      ...
      <a href="mailto:rolf.nilsson@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;background:#fff;color:#C91C22;border:2px solid #C91C22;border-radius:50px;padding:12px 22px;font-family:Rubik,sans-serif;font-weight:600;font-size:0.9375rem;text-decoration:none;">
        ✉ Skicka mail
      </a>
    </div>
  </div>
...
<div class="wp-block-group alignfull has-background" style="background-color:#FAFAF8;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:clamp(1.75rem,4vw,2.25rem);font-weight:700;margin-bottom:0.75rem">Vad säger våra kunder i Torsby?</h2>
  <!-- /wp:heading -->

  <!-- wp:paragraph {"align":"center","style":{"color":{"text":"#6B7280"},"typography":{"fontSize":"1.125rem"},"spacing":{"margin":{"bottom":"3rem"}}}} -->
  <p class="has-text-align-center" style="color:#6B7280;font-size:1.125rem;margin-bottom:3rem">Äkta recensioner från nöjda kunder i Torsby-området.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="stad-testimonials" style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;max-width:1100px;margin:0 auto;">
    <div style="background:#fff;border-radius:20px;padding:32px;box-shadow:0 2px 16px rgba(0,0,0,0.05);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:1rem;color:#374151;line-height:1.7;margin:0 0 16px;">"Göran är en klippa! Städningen är alltid perfekt utförd."</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
            <p style="font-family:Rubik,sans-serif;font-weight:600;font-size:0.875rem;color:#1F2937;margin:0;">Elsy Karlsson, Torsby</p>
    ...
    <div style="background:#fff;border-radius:20px;padding:32px;box-shadow:0 2px 16px rgba(0,0,0,0.05);">
          <div style="display:flex;gap:2px;margin-bottom:12px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div>
          <p style="font-family:Inter,sans-serif;font-size:1rem;color:#374151;line-height:1.7;margin:0 0 16px;">"Målningen av stugan blev kanonbra. Stort tack!"</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
            <p style="font-family:Rubik,sans-serif;font-weight:600;font-size:0.875rem;color:#1F2937;margin:0;">Nils Olsson, Sunne</p>
    ...
    <div style="background:#fff;border-radius:20px;padding:32px;box-shadow:0 2px 16px rgba(0,0,0,0.05);">
          <div style="display:flex;gap:2px;margin-bottom:12px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg><svg width="16" height="16" viewBox="0 0 24 24" fill="#FBBF24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div>
          <p style="font-family:Inter,sans-serif;font-size:1rem;color:#374151;line-height:1.7;margin:0 0 16px;">"Snöskottning och trädgård — de fixar allt!"</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
            <p style="font-family:Rubik,sans-serif;font-weight:600;font-size:0.875rem;color:#1F2937;margin:0;">Sigrid Berglund, Likenäs</p>
...
<div class="wp-block-group alignfull has-background" style="background-color:#4A5568;padding-top:100px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:100px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#fff;font-size:clamp(1.75rem,4vw,2.5rem);font-weight:700;margin-bottom:1rem">Boka hemtjänst i Torsby idag</h2>
  <!-- /wp:heading -->
  ...
  <p class="has-text-align-center" style="color:rgba(255,255,255,0.85);font-size:1.125rem;margin-bottom:2.5rem">Vi matchar dig med rätt senior — lokalt i Torsby och alltid med omtanke.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="wp-block-buttons">
    ...
    <div class="wp-block-button"><a class="wp-block-button__link has-vit-color has-rod-background-color has-text-color has-background wp-element-button" href="/intresse-anmalan" style="border-radius:50px;padding:1rem 2.5rem;font-size:1.125rem;font-weight:700;">Boka hjälp i Torsby</a></div>
    <!-- /wp:button -->
  </div>
  <!-- /wp:buttons -->
  <!-- wp:paragraph {"align":"center","style":{"color":{"text":"rgba(255,255,255,0.6)"},"typography":{"fontSize":"0.875rem"},"spacing":{"margin":{"top":"1rem"}}}} -->
  <p class="has-text-align-center" style="color:rgba(255,255,255,0.6);font-size:0.875rem;margin-top:1rem;">✓ Svar inom 24h &nbsp;·&nbsp; ✓ Inga bindningstider &nbsp;·&nbsp; ✓ Lokalt i Torsby</p>
  <!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
