 ...
 * Description: Franchisetagarfokuserad landningssida för Karlstad
 * Viewport Width: 1440
 */
?>
...
<!-- wp:html -->
<div style="position:relative;min-height:80vh;display:flex;align-items:flex-end;background-image:url('https://staging.seniorbolaget.se/wp-content/uploads/2026/02/franchisee_karlstad.jpg');background-size:cover;background-position:center top;overflow:hidden;">
  ...
  <div style="position:relative;z-index:2;width:100%;padding:clamp(32px,5vw,60px) clamp(24px,5vw,80px);display:flex;justify-content:space-between;align-items:flex-end;flex-wrap:wrap;gap:24px;">
    <div>
      <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.15);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,0.3);border-radius:50px;padding:6px 14px;margin-bottom:16px;color:#fff;font-family:Inter,sans-serif;font-size:0.8125rem;">📍 Seniorbolaget Karlstad</div>
      <h1 style="font-family:Rubik,sans-serif;font-size:clamp(2rem,5vw,3.25rem);font-weight:800;color:#fff;line-height:1.1;margin:0 0 8px;">Hemstädning &amp; hantverkstjänster i Karlstad</h1>
      <p style="font-family:Inter,sans-serif;font-size:1.0625rem;color:rgba(255,255,255,0.85);margin:0 0 20px;">Franchisetagare · Karlstad · Din lokala kontakt</p>
    ...
    <div>
      <a href="/intresseanmalan/" style="display:inline-flex;align-items:center;gap:8px;background:#C91C22;color:#fff;font-family:Rubik,sans-serif;font-size:1.0625rem;font-weight:700;padding:16px 32px;border-radius:50px;text-decoration:none;box-shadow:0 4px 20px rgba(201,28,34,0.5);">Boka i Karlstad →</a>
    </div>
  </div>
</div>
<!-- /wp:html -->
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Som sjuksköterska på Centralsjukhuset i Karlstad såg jag hur viktigt det är att äldre får bo kvar hemma — och hur svårt det kan vara. 2019 bestämde jag mig för att göra något konkret.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Idag leder jag ett team som hjälpt över 320 familjer i Värmland. Från villorna på Hammarö till lägenheterna vid Stora torget — vi finns där du behöver oss, med värmländsk gästfrihet och omtanke.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Det bästa med jobbet? Att se lättnaden i kundernas ögon när de förstår att de kan lita på oss. Förra veckan grät en dam av tacksamhet. Sådana stunder gör allt värt det.</p>
  </div>
  ...
  <div class="service-area-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
    ...
    <div>
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;">
        <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Karlstad</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Hammarö</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Grums</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Kil</span>
      </div>
    </div>
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div style="display:flex;align-items:center;gap:12px;">
          ...
          <span style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;"><strong style="color:#C91C22;">320+</strong> nöjda kunder</span>
        </div>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <p class="has-text-align-center" style="color:#6B7280;font-size:1rem;margin-bottom:3rem">Äkta recensioner från nöjda kunder i Karlstad-området.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="testimonials-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;">
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Anna och teamet är helt enkelt bäst! Städningen är alltid perfekt."</p>
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Fick hjälp med hela trädgården inför hösten. Riktigt nöjd!"</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Snickarna fixade nya fönsterbänkar. Prydligt och snabbt."</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
