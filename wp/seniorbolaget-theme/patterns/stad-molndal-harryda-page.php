...
<div class="franchisee-hero" style="display:flex;gap:48px;align-items:center;flex-wrap:wrap;">
  ...
  <div style="flex:1;min-width:280px;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:1rem;color:#6B7280;margin:0 0 20px;">
      Franchisetagare · Mölndal / Härryda · Sedan 2020
    </p>
    ...
    <p style="font-family:Inter,sans-serif;font-size:1.125rem;color:#374151;line-height:1.7;margin:0 0 28px;max-width:520px;">
      Välkommen! Jag är Håkan och driver Seniorbolaget i Mölndal / Härryda. Vi hjälper dig med allt från städning till trädgård — alltid med omtanke och kvalitet.
    </p>
    ...
    <div style="margin-bottom:24px;">
      <a href="mailto:hakan.viklund@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;text-decoration:none;">
        ✉ Skicka mail till Håkan
      </a>
    </div>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Cecilia Fransson jobbade inom vård och omsorg i 20 år. Hon såg hur äldre ofta fick nöja sig med halvmesyrer.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">När hon startade Seniorbolaget i Mölndal och Härryda 2020 var målet tydligt: leverera det hon själv skulle vilja ha.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Cecilias team kombinerar professionalism med genuin värme. Det är ingen slump att de har så många återkommande kunder.</p>
  </div>
