...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Mikael Ström flyttade till Kungälv för 30 år sedan och blev kvar. Staden vid älven blev hans hem.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Efter en lång karriär inom byggbranschen startade han Seniorbolaget Kungälv 2021. Han ville använda sitt nätverk för något meningsfullt.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Mikael känner sina kunder som grannar — för det är precis vad de ofta är.</p>
  </div>
