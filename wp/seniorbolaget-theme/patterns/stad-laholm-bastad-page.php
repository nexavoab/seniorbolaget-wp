 ...
 * Description: Franchisetagarfokuserad landningssida för Laholm / Båstad
 * Viewport Width: 1440
 */
?>
...
<!-- wp:html -->
<div style="position:relative;min-height:80vh;display:flex;align-items:flex-end;background-image:url('https://staging.seniorbolaget.se/wp-content/uploads/2026/02/franchisee_laholm-bastad.jpg');background-size:cover;background-position:center top;overflow:hidden;">
  ...
  <div style="position:relative;z-index:2;width:100%;padding:clamp(32px,5vw,60px) clamp(24px,5vw,80px);display:flex;justify-content:space-between;align-items:flex-end;flex-wrap:wrap;gap:24px;">
    <div>
      <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.15);backdrop-filter:blur(8px);border:1px solid rgba(255,255,255,0.3);border-radius:50px;padding:6px 14px;margin-bottom:16px;color:#fff;font-family:Inter,sans-serif;font-size:0.8125rem;">📍 Seniorbolaget Laholm/Båstad</div>
      <h1 style="font-family:Rubik,sans-serif;font-size:clamp(2rem,5vw,3.25rem);font-weight:800;color:#fff;line-height:1.1;margin:0 0 8px;">Hemstädning &amp; hantverkstjänster i Laholm/Båstad</h1>
      <p style="font-family:Inter,sans-serif;font-size:1.0625rem;color:rgba(255,255,255,0.85);margin:0 0 20px;">Franchisetagare · Laholm/Båstad · Din lokala kontakt</p>
    ...
    <div>
      <a href="/intresseanmalan/" style="display:inline-flex;align-items:center;gap:8px;background:#C91C22;color:#fff;font-family:Rubik,sans-serif;font-size:1.0625rem;font-weight:700;padding:16px 32px;border-radius:50px;text-decoration:none;box-shadow:0 4px 20px rgba(201,28,34,0.5);">Boka i Laholm/Båstad →</a>
    </div>
  </div>
</div>
<!-- /wp:html -->
  ...
  <div class="service-area-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:start;">
    ...
    <div>
      ...
      <div style="display:flex;gap:10px;flex-wrap:wrap;">
        <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Laholm</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Båstad</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Mellbystrand</span>
            <span style="background:#fff;color:#374151;border-radius:50px;padding:6px 14px;font-size:0.875rem;font-family:Inter,sans-serif;border:1px solid #e5e7eb;">Skummeslövsstrand</span>
      </div>
    </div>
    ...
    <div>
      ...
      <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div style="display:flex;align-items:center;gap:12px;">
          ...
          <span style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;"><strong style="color:#C91C22;">185+</strong> nöjda kunder</span>
        </div>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <p class="has-text-align-center" style="color:#6B7280;font-size:1rem;margin-bottom:3rem">Äkta recensioner från nöjda kunder i Laholm / Båstad-området.</p>
  <!-- /wp:paragraph -->
  ...
  <div class="testimonials-grid" style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px;">
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Ola är fantastisk! Städningen är alltid perfekt utförd."</p>
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Trädgårdsarbetet inför säsongen blev kanon. Tack!"</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
        ...
        <div style="background:#fff;border-radius:16px;padding:28px;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
          ...
          <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#374151;line-height:1.7;margin:16px 0;font-style:italic;">"Snickarna byggde en ny altan åt oss. Helt perfekt!"</p>
          <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;">
...
<div class="wp-block-group alignfull" style="background-color:#C91C22;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="text-align:center;">
    ...
    <div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap;">
      ...
      <a href="mailto:laholm@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;background:transparent;color:#fff;border:2px solid #fff;border-radius:50px;padding:14px 32px;font-family:Rubik,sans-serif;font-weight:600;font-size:1rem;text-decoration:none;">
        Skicka meddelande
      </a>
    </div>
