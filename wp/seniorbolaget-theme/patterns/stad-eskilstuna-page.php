 ...
 * Description: SEO-landningssida för Eskilstuna
 * Viewport Width: 1440
 */
?>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:clamp(1.75rem,4vw,2.25rem);font-weight:700;margin-bottom:2rem">Din lokala kontakt i Eskilstuna</h2>
  <!-- /wp:heading -->

  <!-- wp:html -->
  <div style="background:#FFF4F2;border-radius:24px;padding:40px;max-width:520px;margin:0 auto;text-align:center;">
    <div style="width:72px;height:72px;background:#C91C22;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 16px;font-family:Rubik,sans-serif;font-size:1.5rem;font-weight:700;color:#fff;">IG</div>
    <p style="font-family:Rubik,sans-serif;font-weight:700;font-size:1.25rem;color:#1F2937;margin:0 0 4px;">Isa Gemmel</p>
    <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;margin:0 0 20px;">Ansvarig Eskilstuna</p>
    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
      ...
      <a href="mailto:isa.gemmel@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;background:#fff;color:#C91C22;border:2px solid #C91C22;border-radius:50px;padding:12px 24px;font-family:Rubik,sans-serif;font-weight:600;font-size:0.9375rem;text-decoration:none;">Skicka mail</a>
    </div>
  </div>
  <!-- /wp:html -->
