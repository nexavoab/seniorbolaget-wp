...
<div class="franchisee-photo" style="flex:0 0 auto;">
    <div style="width:280px;height:340px;border-radius:24px;overflow:hidden;flex-shrink:0;border:3px solid rgba(201,28,34,0.12);box-shadow:0 8px 32px rgba(0,0,0,0.12);">
      <img src="https://staging.seniorbolaget.se/wp-content/uploads/2026/02/franchisee_eskilstuna.jpg" alt="Isa Gemmel, franchisetagare Seniorbolaget Eskilstuna" 
  ...
  <div style="flex:1;min-width:280px;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:1.125rem;color:#374151;line-height:1.7;margin:0 0 28px;max-width:520px;">
      Välkommen! Jag är Isa och driver Seniorbolaget i Eskilstuna. Vi hjälper dig med allt från städning till trädgård — alltid med omtanke och kvalitet.
    </p>
    ...
    <div style="margin-bottom:24px;">
      <a href="mailto:isa.gemmel@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;text-decoration:none;">
        ✉ Skicka mail till Isa
      </a>
    </div>
