 ...
 * Description: SEO-landningssida för Kristianstad
 * Viewport Width: 1440
 */
?>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:clamp(1.75rem,4vw,2.25rem);font-weight:700;margin-bottom:2rem">Din lokala kontakt i Kristianstad</h2>
  <!-- /wp:heading -->
  ...
  <div style="background:#FFF4F2;border-radius:24px;padding:40px;max-width:520px;margin:0 auto;text-align:center;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;margin:0 0 20px;">Ansvarig Kristianstad</p>
