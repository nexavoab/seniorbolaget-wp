...
<div class="franchisee-hero" style="display:flex;gap:48px;align-items:center;flex-wrap:wrap;">
  ...
  <div style="flex:1;min-width:280px;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:1rem;color:#6B7280;margin:0 0 20px;">
      Franchisetagare · Kristianstad · Sedan 2020
    </p>
    ...
    <p style="font-family:Inter,sans-serif;font-size:1.125rem;color:#374151;line-height:1.7;margin:0 0 28px;max-width:520px;">
      Välkommen! Jag är Peter och driver Seniorbolaget i Kristianstad. Vi hjälper dig med allt från städning till trädgård — alltid med omtanke och kvalitet.
    </p>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Johan Nilsson jobbade inom servicebranschen i Kristianstad i över 20 år. Han kände alla hantverkare i stan — och visste vilka som var bäst.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">När han startade Seniorbolaget 2020 hade han en färdig lista på folk att ringa. Inom tre månader var teamet komplett.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Johan tror på Skånes tradition av ordning och reda. Hans kunder vet alltid exakt vad de får.</p>
  </div>
