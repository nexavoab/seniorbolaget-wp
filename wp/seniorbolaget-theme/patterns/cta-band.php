...
<div class="wp-block-group alignfull has-background has-text-color" style="background-color:#4A5568;color:#ffffff">
	...
	<div class="wp-block-group" style="text-align:center">
		...
		<!-- wp:heading {"level":2,"style":{"typography":{"fontWeight":"700","lineHeight":"1.15","fontSize":"clamp(2rem, 5vw, 3rem)"},"color":{"text":"#ffffff"}}} -->
		<h2 class="wp-block-heading" style="color:#ffffff;font-size:clamp(2rem, 5vw, 3rem);font-weight:700;line-height:1.15">Få tiden tillbaka, vi fixar det!</h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"style":{"typography":{"fontSize":"var:preset|font-size|lg","lineHeight":"1.6"},"color":{"text":"rgba(255,255,255,0.9)"},"spacing":{"margin":{"top":"var:preset|spacing|md"}}}} -->
		<p style="color:rgba(255,255,255,0.9);font-size:var(--wp--preset--font-size--lg);line-height:1.6;margin-top:2rem">Din vardag behöver inte fler måsten. Våra seniora proffs tar hand om det praktiska med omsorg och precision, så att du kan lägga tiden där den gör mest nytta.</p>
		<!-- /wp:paragraph -->
