...
<div class="franchisee-hero" style="display:flex;gap:48px;align-items:center;flex-wrap:wrap;">
  ...
  <div style="flex:1;min-width:280px;">
    ...
    <p style="font-family:Inter,sans-serif;font-size:1rem;color:#6B7280;margin:0 0 20px;">
      Franchisetagare · Nässjö · Sedan 2021
    </p>
    ...
    <p style="font-family:Inter,sans-serif;font-size:1.125rem;color:#374151;line-height:1.7;margin:0 0 28px;max-width:520px;">
      Välkommen! Jag är Lennart och driver Seniorbolaget i Nässjö. Vi hjälper dig med allt från städning till trädgård — alltid med omtanke och kvalitet.
    </p>
    ...
    <div style="margin-bottom:24px;">
      <a href="mailto:lennart.ljungdahl@seniorbolaget.se" style="display:inline-flex;align-items:center;gap:8px;font-family:Inter,sans-serif;font-size:0.9375rem;color:#6B7280;text-decoration:none;">
        ✉ Skicka mail till Lennart
      </a>
    </div>
...
<div class="wp-block-group alignfull" style="padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
  ...
  <div style="margin-bottom:2rem;">
    <p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Christer Söderberg har bott i Nässjö hela sitt liv. Han känner staden och dess folk bättre än de flesta.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Efter 30 år som hantverkare startade han Seniorbolaget 2021. Han ville ge småstaden samma kvalitet som de stora.</p>
<p style="font-family:Inter,sans-serif;font-size:1rem;line-height:1.8;color:#374151;margin:0 0 1rem;">Christer säger att i Nässjö ringer folk inte för att klaga — de ringer för att tacka. Det är det bästa kvittot.</p>
  </div>
