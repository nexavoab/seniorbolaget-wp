<?php
/**
 * Title: Om oss - Infosida
 * Slug: seniorbolaget/om-oss-page
 * Categories: seniorbolaget, info
 * Description: Om Seniorbolaget - företagets historia och värdegrund
 * Viewport Width: 1440
 */
?>
...
<div class="wp-block-group alignfull" style="background-color:#FFF4F2;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","textTransform":"uppercase","letterSpacing":"0.1em","fontSize":"0.875rem"},"color":{"text":"#C91C22"},"spacing":{"margin":{"bottom":"0.75rem"}}}} -->
	<p style="color:#C91C22;font-size:0.875rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:0.75rem">Om oss</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons" style="margin-bottom:1.5rem">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-rod-background-color has-vit-color has-text-color has-background wp-element-button" href="/intresse-anmalan" style="border-radius:50px;padding:1rem 2rem;font-weight:600;font-size:1.125rem">Kontakta oss</a></div>
		<!-- /wp:button -->
	...
	<!-- wp:html -->
	<div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:1.5rem;">
		<div style="display:inline-flex;align-items:center;gap:8px;background:#fff;border:1.5px solid #e5e7eb;border-radius:50px;padding:10px 20px;font-size:1rem;font-weight:600;color:#1F2937;box-shadow:0 1px 4px rgba(0,0,0,0.06);">
			...
			<span>26 orter i Sverige</span>
		</div>
		<div style="display:inline-flex;align-items:center;gap:8px;background:#fff;border:1.5px solid #e5e7eb;border-radius:50px;padding:10px 20px;font-size:1rem;font-weight:600;color:#1F2937;box-shadow:0 1px 4px rgba(0,0,0,0.06);">
			<svg width="18" height="18" viewBox="0 0 24 24" fill="#C91C22"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
			<span>Sedan 2008</span>
		</div>
		<div style="display:inline-flex;align-items:center;gap:8px;background:#fff;border:1.5px solid #e5e7eb;border-radius:50px;padding:10px 20px;font-size:1rem;font-weight:600;color:#1F2937;box-shadow:0 1px 4px rgba(0,0,0,0.06);">
...
<div class="wp-block-group alignfull" style="background-color:#FFFFFF;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:65%">
			...
			<h2 class="wp-block-heading" style="color:#1F2937;font-size:1.75rem;font-weight:700;margin-bottom:1.5rem">Henrik Bergeld, grundare</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.125rem","lineHeight":"1.7"},"color":{"text":"#4B5563"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
			<p style="color:#4B5563;font-size:1.125rem;line-height:1.7;margin-bottom:1rem">Jag hade lyckan att starta Seniorbolaget på Tjörn redan 2008. Allt började med en enkel men stark tanke: att ta tillvara den enorma kunskap, erfarenhet och arbetsglädje som finns hos pensionärer.</p>
			<!-- /wp:paragraph -->
			...
			<p style="color:#4B5563;font-size:1.125rem;line-height:1.7;margin-bottom:2rem">I dag är Seniorbolaget rikstäckande. Vår grundidé är densamma: att matcha rätt kompetens med rätt behov, oavsett om det gäller en privatperson, ett företag eller en bostadsrättsförening.</p>
			<!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull" style="background-color:#FAFAF8;margin-top:0;padding-top:80px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:80px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="color:#1F2937;font-size:2rem;font-weight:700;margin-bottom:3rem">Det som gör oss starka</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="background-color:#fff;border-radius:20px;padding:2rem">
				<!-- wp:html -->
				<div style="width:64px;height:64px;background:#FFF4F2;border-radius:16px;display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
				</div>
				<!-- /wp:html -->
				<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.375rem","fontWeight":"600"},"color":{"text":"#1F2937"},"spacing":{"margin":{"bottom":"0.75rem"}}}} -->
				<h3 class="wp-block-heading" style="color:#1F2937;font-size:1.375rem;font-weight:600;margin-bottom:0.75rem">Livserfarenhet</h3>
				<!-- /wp:heading -->
				<!-- wp:paragraph {"style":{"color":{"text":"#4B5563"},"typography":{"fontSize":"1.0625rem","lineHeight":"1.6"}}} -->
				<p style="color:#4B5563;font-size:1.0625rem;line-height:1.6">Våra seniorer har årtionden av kunskap och rutin. Den erfarenheten gör verklig skillnad i varje uppdrag de utför.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="background-color:#fff;border-radius:20px;padding:2rem">
				<!-- wp:html -->
				<div style="width:64px;height:64px;background:#FFF4F2;border-radius:16px;display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><polyline points="9 12 11 14 15 10"/></svg>
				</div>
				<!-- /wp:html -->
				<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.375rem","fontWeight":"600"},"color":{"text":"#1F2937"},"spacing":{"margin":{"bottom":"0.75rem"}}}} -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="background-color:#fff;border-radius:20px;padding:2rem">
				<!-- wp:html -->
				<div style="width:64px;height:64px;background:#FFF4F2;border-radius:16px;display:flex;align-items:center;justify-content:center;margin-bottom:20px;">
					<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#C91C22" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
				</div>
				<!-- /wp:html -->
				<!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"1.375rem","fontWeight":"600"},"color":{"text":"#1F2937"},"spacing":{"margin":{"bottom":"0.75rem"}}}} -->
...
<div class="wp-block-group alignfull" style="background-color:#C91C22;margin-top:0;padding-top:60px;padding-right:clamp(24px, 5vw, 80px);padding-bottom:60px;padding-left:clamp(24px, 5vw, 80px)">
	...
	<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:32px;max-width:900px;margin:0 auto;text-align:center;">
		<div>
			<p style="font-family:Rubik,sans-serif;font-size:3rem;font-weight:700;color:#fff;margin:0;">500+</p>
			<p style="font-family:Inter,sans-serif;font-size:1rem;color:rgba(255,255,255,0.9);margin:8px 0 0;">Seniorer</p>
		</div>
		<div>
			<p style="font-family:Rubik,sans-serif;font-size:3rem;font-weight:700;color:#fff;margin:0;">1000+</p>
			<p style="font-family:Inter,sans-serif;font-size:1rem;color:rgba(255,255,255,0.9);margin:8px 0 0;">Nöjda kunder</p>
		</div>
		<div>
			<p style="font-family:Rubik,sans-serif;font-size:3rem;font-weight:700;color:#fff;margin:0;">26</p>
	...
	@media (max-width: 768px) {
		.wp-block-group[style*="C91C22"] div[style*="grid-template-columns:repeat(4,1fr)"] { grid-template-columns: repeat(2, 1fr) !important; }
	}
	</style>
	<!-- /wp:html -->
...
<div class="wp-block-group alignfull has-background" style="background-color:#1F2937;padding-top:100px;padding-bottom:100px;">
	...
	<h2 class="wp-block-heading has-text-align-center" style="color:#fff;font-size:clamp(1.75rem,4vw,2.5rem);font-weight:700;margin-bottom:1rem;">Redo att få hjälp?</h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"align":"center","style":{"color":{"text":"rgba(255,255,255,0.9)"},"typography":{"fontSize":"1.25rem"},"spacing":{"margin":{"bottom":"2.5rem"}}}} -->
	<p class="has-text-align-center" style="color:rgba(255,255,255,0.9);font-size:1.25rem;margin-bottom:2.5rem;">Skicka en förfrågan så kontaktar vi dig inom 24 timmar.</p>
	<!-- /wp:paragraph -->
