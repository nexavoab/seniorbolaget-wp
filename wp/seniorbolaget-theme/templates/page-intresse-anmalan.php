<?php
/**
 * Template Name: Intresseanmälan Wizard
...
<main id="main" class="site-main">
    <div class="entry-content">
        <h1 class="wp-block-heading has-text-align-center" style="margin-bottom: 0;">Intresseanmälan</h1>
            ...
            <div class="wizard-inner">
                ...
                <div x-show="step === 1" x-transition>
                    <div class="wizard-header">
                        <h2 class="wizard-title">Vad behöver du hjälp med?</h2>
                ...
                <div x-show="step === 5" x-transition>
                    <div class="thank-you">
                        ...
                        <a href="/" class="back-home-btn">Tillbaka till startsidan</a>
                    </div>
                </div>
